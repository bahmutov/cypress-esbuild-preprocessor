...
![cypress version](https://img.shields.io/badge/cypress-14.0.3-brightgreen) ![esbuild version](https://img.shields.io/badge/esbuild-0.25.0-brightgreen) [![ci status][ci image]][ci url]
