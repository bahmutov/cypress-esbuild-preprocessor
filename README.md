...
![cypress version](https://img.shields.io/badge/cypress-8.2.0-brightgreen) ![esbuild version](https://img.shields.io/badge/esbuild-0.12.19-brightgreen) [![ci status][ci image]][ci url]
