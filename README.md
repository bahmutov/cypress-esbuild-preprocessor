...
![cypress version](https://img.shields.io/badge/cypress-15.8.1-brightgreen) ![esbuild version](https://img.shields.io/badge/esbuild-0.27.2-brightgreen) [![ci status][ci image]][ci url]
