...
![cypress version](https://img.shields.io/badge/cypress-15.12.0-brightgreen) ![esbuild version](https://img.shields.io/badge/esbuild-0.27.4-brightgreen) [![ci status][ci image]][ci url]
