...
![cypress version](https://img.shields.io/badge/cypress-14.5.3-brightgreen) ![esbuild version](https://img.shields.io/badge/esbuild-0.25.8-brightgreen) [![ci status][ci image]][ci url]
