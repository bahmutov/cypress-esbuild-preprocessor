...
![cypress version](https://img.shields.io/badge/cypress-15.7.1-brightgreen) ![esbuild version](https://img.shields.io/badge/esbuild-0.27.1-brightgreen) [![ci status][ci image]][ci url]
