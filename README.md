...
![cypress version](https://img.shields.io/badge/cypress-14.4.0-brightgreen) ![esbuild version](https://img.shields.io/badge/esbuild-0.25.5-brightgreen) [![ci status][ci image]][ci url]
