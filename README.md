...
![cypress version](https://img.shields.io/badge/cypress-14.5.2-brightgreen) ![esbuild version](https://img.shields.io/badge/esbuild-0.25.7-brightgreen) [![ci status][ci image]][ci url]
