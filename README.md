...
![cypress version](https://img.shields.io/badge/cypress-13.9.0-brightgreen) ![esbuild version](https://img.shields.io/badge/esbuild-0.21.2-brightgreen) [![ci status][ci image]][ci url]
