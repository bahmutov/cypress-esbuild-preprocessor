...
![cypress version](https://img.shields.io/badge/cypress-15.14.2-brightgreen) ![esbuild version](https://img.shields.io/badge/esbuild-0.28.0-brightgreen) [![ci status][ci image]][ci url]
